...
Defined as physical injury and the body´s consequential response, trauma, is one of the leading causes of mortality and morbidity in all age groups worldwide the leading cause of mortality below the age of 44 [@David2021][@champion1990]. Approximately 5.8 million people die each year due to trauma. Motor vehicle crashes alone stands for more than one million deaths and roughly between 20 and 50 million injuries annually [@Committee2013]. With an average of more than 7 days in the hospital each stay [@champion1990], it is one of the most prevalent reasons for admission.
<!-- Maximalt med info för varje mening, så undvik upprepningar. Överväg att lägga till något om DALYs -->
...
<!-- Jag skulle fokusera stycket på preventable deaths/OFI för att naturlig kunna gå över till förbättring av traumavården via kvalitetsarbeten/MoM i nästa stycke-->
...
<!--Nyckeln till detta stycket bör vara: MoM är gold standard för kvalitetsutveckling inom traumavården. Men, det är ett stort problem att välja vilka patienter som ska granskas och det är en resurskrävande process -->
...
<!--Detta stycke bör förmedla: Vi har ingen aning om vilka faktorer som är accosierade med förbättringsmöjligheter. Då vi inte vet bättre används bl.a audit filters (det som görs på KS bla) men det behövs mer forskning-->
...
<!--Standardiserade Audit filters används idag på KS men ingen har faktiskt tittat på hur de accosierar med utfallet. Idag är det: systolic blood pressure less than 90, Glasgow coma scale less than 9 and not intubated,injury severity score more than 15 but not admitted to the intensive care unit, time to acute intervention more than 60 minutes, time to computed tomography more than 30 minutes, death within 30 days after trauma. Swetrau inehåller dock ca 50 olika parametrar men ingen har överhuvud taget tittat hur resten accosierar, vilket är det du ska göra -->
# Methods
...
<!-- Skriv ut de exakta registernamnen. Undvik värderande ord likt "only". Länken mellan de två registren görs via en gemensam ID parameter men detta behöver ej vara med i study design. -->
### Setting
...
<!--Delar av detta stycker hör om något till introduktionen. Här räcker det med att beskriva traumasystemet i KS. Level one trauma center, direct access to a multidicsiplinary team, radiology and intervention and operation, etc etc. Lite kort om den prehospitala biten. -->
...
<!--Delar är irrelevant medans vissa sajer kan användas i exv predictors -->
