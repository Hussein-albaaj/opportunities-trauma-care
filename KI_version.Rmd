...
*Bakgrund*: Trauma är en av de ledande orsakerna till mortalitet och morbiditet oberoende av ålder. Som observerats i många tidigare studier så är utfallet för patienterna beroende på kvaliteten av sjukvården. Mortalitet- och mobiditetskonferenser äger rum för att förbättra kvaliteten av traumavården. Under konferanserna diskuteras specifika fall för att identifiera förbättringsmöjligheter. Det saknas konsensus för hur fall skall selekteras till konferenserna. *Syfte*: Bedöma hur olika faktorer associeras med förbättringsmöjligheter inom trauma. *Metoder*: En retrospektiv kohortstudie genomfördes med data från traumaregistret och vårdkvalitetsdatabasen vid Karolinska Universitetssjukhuset i Solna. Associationerna mellan tio faktorer och förbättringsmöjligheter som utfall undersöktes med bi- och multivariabel logistisk regression. *Resultat*: Totalt 4643 patienter inkluderades. Förbättringsmöjligheter identifierades i 276 (5.94%) av alla fall. Medianåldern för patienter med förbättringsmöjligheter var 49, 42 i patienter utan förbättringsmöjligheter. Patienterna med förbättringsmöjligheter var i genomsnitt mer skadade men en "injury severity score" (ISS) på 17 jämfört med 5 hos patienter utan förbättringsmöjligheter. Statisktiskt signifikans identifierades hos bland annat variabeln "högsta vårdnivån" med en oddskvot för förbättringsmöjligheter på 15.7 vid specialiserade avdelningar jämfört med akuten. *Slutsats*: Högsta vårdnivå, ålder och ISS var tydligt associerade med förbättringsmöjligheter inom trauma. Framtida studier avseende förbättringsarbeten för traumapatienter bör fokusera på varför det finns skillnader i förekomsten av förbättringsmöjligheter bland de olika faktorerna.

### Factors associated with opportunities for improvement in trauma care: A registry-based retrospective cohort study
*Background*: Trauma is one of the leading causes of mortality and morbidity in all age groups. As observed in many previous studies, the outcome in different cases is mostly dependent on the quality of care provided. To improve the quality of care in trauma, mortality and morbidity conferences take place, during which specific cases are reviewed to identify opportunities for improvement (OFI). It is not clear how to select cases for review in an efficient way. *Aims*: To asses how patient level factors are associated with opportunities for improvement in trauma care. *Methods*: A retrospective cohort study was conducted using data from the trauma registry and the trauma care quality database at the Karolinska University Hospital in Solna. The associations between ten factors and OFI as an outcome were assessed using bi- and multivariable logistic regression. *Results*: A total of 4643 cases were included in the study. OFI was identified in 276 (5.94%) out of the cases. The median age for patients with OFI was 49 compared to 42 in patients without OFI. Factors found to be statistically significant were age, highest hospital care level, injury severity score, respiratory rate, systolic blood pressure, glasgow coma scale, survival after 30 days and intubation. *Conclusion*: Higher hospital care level, age and ISS were found to be highly associated with OFI in trauma care. Future research should focus on identifying why OFI are more common in some patient level factors compared to others.
...
As previously mentioned, the study can in no way harm the patients included since it contains no intervention. Sensitive information is used during the study. However, we will use secure networks when working on non-scrambled data. We believe the risk of sensitive information leakage is minimal.
