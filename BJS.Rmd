...
*Background*: Trauma is one of the leading causes of morbidity and mortality worldwide. Morbidity and mortality review is used to improve the quality of trauma care. During this review specific patient cases are reviewed to identify opportunities for improvement (OFI). <!--The selection of cases for review is often inefficient.!! I suggest that we remove this line, as it's not clear how it relates to you study--> The aim of this study was to assess how certain patient level factors are associated with OFI in trauma care.
...
# Discussion
We found that age, hospital care level and ISS were significantly associated with OFI in both unadjusted and adjusted analyses. The factor most strongly associated with OFI was the highest hospital care level, with an odds ratio of 15.7 and 12.1 in High Dependency Units and Critical Care Units respectively, compared to the Emergency Department. This means that patients treated in the High Dependency Units and Critical Care Units are more likely to be exposed to preventable errors. A previous study in the US has shown that more than half of the preventable and probably preventable deaths occur in Critical Care Units [@Teixeira2007]. This could be explained by the complexity, severity and high number of interventions needed for cases treated in Critical Care Units. According to the same study the most prevalent OFI were related to airway management and perioperative care and those patients are usually found in Critical Care Units [@Teixeira2009]. The cases in the High Dependency Units are also complex, although these wards lack the access to the same amount of resources and personnel as Critical Care Units. This could explain why the odds ratio of OFI is even higher in High Dependency Units compared to Critical Care Units. Patients with Emergency Department as the highest hospital care level are usually less injured and therefore need less intervention which in turn leads to lower odds of OFI. 

It is important to acknowledge that OFI is not the same as preventable deaths considering that OFI only imply that there is a preventable error but not the magnitude of that error. Our study shows that there is an association between death within 30 days after trauma and OFI. Before the adjustment for other factors the p-value for death within 30 days was not significant. There was however a significant association after adjustment, suggesting higher odds of OFI in patients that are alive after 30 days. The reason could be that patients that die within 30 days are usually more injured, with higher ISS, higher hospital care level and higher probability of intubation. After the adjustment for these and other variables the model shows lower odds of OFI in patients that die within 30 days.

In our study OFI was identified in 6.8% of all trauma deaths at Karolinska University Hospital. A study performed by colleagues at the same hospital identified at least one preventable error in 21% of all trauma deaths, although only 4% of all trauma deaths were found to be preventable [@Ghorbani2018]. That study was published 2014 and OFI was registered through the decision made by two trauma surgeons. A possible explanation for the decreased numbers of OFI in trauma deaths could be due to the adaption of new treatment strategies and the implementation of quality improvement programs. However the criteria used to determine the presence of OFI during that time was different, and therefore the results do not necessarily mean a decrease in OFI.
