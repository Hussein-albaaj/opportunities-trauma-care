...
### Factors associated with opportunities for improvement in trauma care: A registry-based study
...
*Conclusion*: Several patient level factors were found to be associated with OFI. Future research should focus on identifying reasons to why these factors are associated with higher odds of OFI.
...
Fig.\@ref(fig:flowchart-process) describes the morbidity and mortality review process. Specialised nurses review all trauma patients presenting to the Karolinska University Hospital. To facilitate their initial review they apply audit filters to identify cases in which OFI are more likely. These filters are systolic blood pressure under 90, GCS less than 9 and not intubated, ISS more than 15 but not admitted to the ICU, time to acute intervention more than 60 minutes, time to computed tomography more than 30 minutes, and death within 30 days after trauma. 
...
The variable highest hospital care level is divided into 5 categories: Emergency Department, General Ward, Surgical Ward, High Dependency Unit and Critical Care Unit. Patients that are in need of higher level of care that can not be provided in the usual General Ward but do not require intensive care are admitted to High Dependency Units such as dedicated trauma wards with high monitoring. Patients with multi-organ failure or that can not breathe without medical help are admitted to Critical Care Units such as Cardiothoracic Intensive Care Unit and pediatric intensive care unit [@Utstein2009]. The definition of Critical Care Units is mostly dependent on the nurse to patient ratio [@Manual2019].
...
# Discussion
We found that age, hospital care level and ISS were significantly associated with OFI in both unadjusted and adjusted analyses. The factor most strongly associated with OFI was the highest hospital care level, with an odds ratio of 15.7 and 12.1 in High Dependency Units and Critical Care Units respectively, compared to the Emergency Department. This means that patients treated in the High Dependency Units and Critical Care Units are more likely to be exposed to preventable errors. A previous study in the US has shown that more than half of the preventable and probably preventable deaths occur in Critical Care Units [@Teixeira2007]. This could be explained by the complexity, severeness and amount of intervention needed for cases treated in Critical Care Units. According to the same study the most prevalent OFI were related to airway management and perioperative care and those patients are usually found in Critical Care Units [@Teixeira2009]. The cases in the High Dependency Units are also complex, although these wards lack the access to the same amount of resources and personnel as Critical Care Units. This could explain why the odds ratio of OFI is even higher in High Dependency Units compared to Critical Care Units. Patients with Emergency Department as the highest hospital care level are usually less injured and therefore need less intervention which in turn leads to lower odds of OFI. 
...
Other factors associated with OFI are the continuous factors age and ISS. As seen in Table \@ref(tab:sample-characteristics) the median age differs between the two different groups, it is higher by 7 years in the OFI group. The reason behind the higher percentage of OFI in older patients is still unclear. A systematic review published 2017 identified many studies where lower healthcare quality for elders was potentially justified by the lower chance of survival [@Salway2017]. The argument that focusing more resources on younger patients could lead to a lower mean value of disability-adjusted life years could be made. However, more research is needed to clarify if such a prejudice is present.
