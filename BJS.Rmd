...
# Results
<!-- Try to be consistent in how you both present your results as well as discuss them. For example, you currently move between first presenting odds ratios and then percentages. To me, percentages are descriptive statistics, and should be presented before the results of bi- and multivariable analyses-->
...
# Discussion
We found that age, hospital care level and ISS were significantly associated with OFI in both unadjusted and adjusted analyses<!-- In the results in the abstract it says that systolic blood pressure, respiratory rate, and GCS were associated with OFI. Why are these not mentioned here?-->. We also found that death within 30 days after trauma was negatively associated with OFI in adjusted analysis, suggesting higher odds of OFI in patients who are alive after 30 days. 

The factor most strongly associated with OFI was the highest hospital care level, with an odds ratio of 15.7 and 12.1 in High Dependency Units and Critical Care Units respectively, compared to the Emergency Department. This means that patients treated in the High Dependency Units and Critical Care Units are more likely to be exposed to preventable errors. A previous study in the US has shown that more than half of the preventable and probably preventable deaths occur in Critical Care Units [@Teixeira2007]. This could be explained by the complexity, severity and high number of interventions needed for cases treated in Critical Care Units. According to the same study the most prevalent OFI were related to airway management and perioperative care and those patients are usually treated in Critical Care Units [@Teixeira2009]. The cases in the High Dependency Units are also complex, but these wards lack access to the resources and personnel found in Critical Care Units. This could explain why the odds ratio of OFI is even higher in High Dependency Units compared to Critical Care Units. Patients with Emergency Department as the highest hospital care level are usually less injured and therefore need fewer interventions which in turn may lead to lower odds of OFI. 

We found that patients who were alive 30 days after trauma had higher odds of OFI, in adjusted analysis. The reason could be that patients that die within 30 days are usually more injured, with higher ISS, higher hospital care level and higher probability of intubation. After the adjustment for these and other variables the model shows lower odds of OFI in patients that die within 30 days.<!-- Try to elaborate on this explanation. If this was the explanation, then I would expect death at 30 days to be associated with OFI in the unadjusted analysis but not in the adjusted, because the association would be "explained away" by these other factors.-->

In our study OFI was identified in 6.8% of all trauma deaths at Karolinska University Hospital. A previous study from the same hospital identified at least one preventable error in 21% of all trauma deaths, although only 4% of all trauma deaths were found to be preventable [@Ghorbani2018]. That study was published 2014<!-- The citation says 2018?--> and OFI was registered through the decision made by two trauma surgeons. A possible explanation for the lower number of OFI in those who died in our study compared to the previous study could be due to the adaption of new treatment strategies and the implementation of quality improvement programs. However the criteria used to determine the presence of OFI during that time was different, and therefore the results do not necessarily mean a decrease in OFI<!-- I think the difference between 21 and 7 is too large to be explained by changes in care. We can discuss this with Lisa and Olof when we meet, but I would rather attribute the difference to the way OFI were identified-->.

Other factors associated with OFI are age and ISS. As seen in Table \@ref(tab:sample-characteristics) the median age differs between the two different groups, it is higher by 7 years in the OFI group<!-- It's uncommon to reference tables and figures in the discussion. I would avoid that and instead just write that there was a seven year difference in mean age between those with and without OFI-->. This difference that older patients have increased odds of OFI. The reason behind these increased odds is unclear. A systematic review published 2017 identified many studies where lower healthcare quality for elders was potentially justified by the lower chance of survival [@Salway2017]. The argument that focusing more resources on younger patients could lead to a lower mean value of disability-adjusted life years could be made. However, more research is needed to clarify if such a prejudice is present.<!-- It is well known that the clinical presentation is different in old compared to young trauma patients, with different physiological response and confounding such as different medicines. I would probably discuss this rather than potential "ageism". -->

The median ISS was 17 in the group with OFI compared to 5 in cases with no OFI, meaning that OFI are more likely to be identified in patients with more complex trauma. This could be due to lack of training or protocols in the care of patients with severe injuries. Another explanation could be due to lack of resources needed for severe injuries<!-- I would think that it's because it's more difficult to treat patients with serious trauma compared to not so serious trauma-->. Two studies performed in Germany showed higher numbers of preventable errors in patients with ISS > 15 compared to the whole population. In Cologne when analyzing preventable and potentially preventable deaths in patients with ISS > 15 they estimated it to be 20.2% of all trauma deaths [@Schoeneberg2016]. When calculating the same numbers for all patients, regardless of ISS, in Berlin it was estimated to be 15.1% of all trauma deaths [@Kleber2013].<!-- I would end the paragraph with the potential explanation instead, and cite this source before --> 

When analyzing the vital signs included, some associations with OFI was found. The model failed to estimate an association between three groups in systolic blood pressure, two groups in respiratory rate and OFI respectively. This could be due to the lack of patients in these groups. In respiratory rate >29 an OFI was found in 11.0% of the cases, compared to 5.8% in 10-29. A study performed in Iran showed similar findings when comparing preventable deaths between patients with a respiratory rate <20 and 20 or higher. It was found that deaths in patients with 20 or higher in respiratory rate were more likely to be preventable [@Davoodabadi2021]. A theory explaining this could be that hyperventilation is usually a sign of severity in trauma. The hyperventilation could be due to lactic acidosis. The lactate is a anaerobic metabolism and its accumulation in trauma patients is likely due to a severe hemorrhagic shock [@Richards2018]. Hyperventilation could also be a sign of comorbidity, a predictor of morbidity and mortality in trauma patients [@Mubang2015]. These complications could be the reason behind higher percentage of OFI in patients with respiratory rate over 29.<!-- Do we need this deep dive into hyperventilation? Doesn't this finding also play well with more serious patients having higher odds of OFI?-->

Patients who were intubated after arriving to hospital had increased odds of OFI compared to patients who were not intubated. Patients who were intubated in the prehospital setting did not have significantly higher odds of OFI compared to patients who were not intubated. One potential explanation of the higher odds of OFI in patients intubated after the arrival at the hospital could be the delay of intubation in these cases.<!-- Can you elaborate on this?--> 

All trauma 1 patients were reviewed by specialised nurses, but the selection for review by the morbidity and mortality conference relied mostly on audit filters. <!-- I don't think selection bias is the right word here, but some bias is definitely introduced, so elaborate on that. Also, write something about this being a single centre study--> 
