...
An opportunity for improvement was identified in `r sum(aa$probYN == "Opportunity for improvement")` (`r round(sum(aa$probYN == "Opportunity for improvement")/nrow(aa)*100, digits = 2)`%) out of the cases. All selected variables unadjusted are presented in Table 2 with respective p-value. Adjusted variables are presented in Table 3 through the use of logistic regression. Statistical significance was found in the variables 
